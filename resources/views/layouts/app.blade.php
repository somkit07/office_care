...
<head>
    ...
    <link href="{{ asset('public/backend/plugins/jquery-ui/themes/base/minified/jquery-ui.min.css') }}"
        rel="stylesheet')}}" />
                ...
                <ul class="nav navbar-nav navbar-right">
                    <li class="dropdown navbar-user">
                        <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown">
                            ...
                            <span class="hidden-xs"><?php if (!empty($row_user)) {
                        ...
                        <ul class="dropdown-menu animated fadeInLeft">
                            ...
                            @if (Session::get('department_id') == '1')
                                <li><a href="{{ url('backend/user/user_add_edit/' . Session::get('user_id')) }}">Edit
                                        User</a></li>
                                <li class="divider"></li>
                            @endif
            ...
            <div data-scrollbar="true" data-height="100%">
                ...
                <ul class="nav">
                    <li class="nav-profile">
                        <div class="image">
                            <a href="javascript:;"><img src="{{ asset('public/backend/img/user-13.jpg') }}"
                                    alt="" /></a>
                        </div>
                        <div class="info">
                            ...
                            <ul class="sub-menu">
                                <li class="has-sub menu_sub_authen"><a href="javascript:check_menu(1);">Authen</a>
                                    <ul class="sub-menu sub_menu_1">
                                        <li class="sub_sub_menu_department"><a
                                                href="{{ url('backend/department/') }}">Department</a></li>
                                        <li class="sub_sub_menu_user"><a href="{{ url('backend/user/') }}">User</a>
                                        </li>
                                    </ul>
                                </li>
                                <li class="menu_banner_slide"><a href="{{ url('backend/banner_slide/') }}">Banner
                                        Slide</a></li>
                                <li class="menu_image_right_index"><a
                                        href="{{ url('backend/image_right_index/') }}">รูปภาพหน้าแรก ด้านขวามือ
                                        และตรงกลาง</a></li>
                                <li class="has-sub menu_sub_authen"><a href="javascript:check_menu(2);">Product</a>
                                    <ul class="sub-menu sub_menu_2">
                                        <li class="sub_menu_category1"><a
                                                href="{{ url('backend/category1/') }}">Category 1</a></li>
                                        <li class="sub_menu_category2"><a
                                                href="{{ url('backend/category2/') }}">Category 2</a></li>
                                        <li class="sub_menu_category3"><a
                                                href="{{ url('backend/category3/') }}">Category 3</a></li>
                                        <li class="sub_menu_color"><a href="{{ url('backend/color/') }}">Color</a>
                                        </li>
                                        <li class="sub_menu_brand"><a href="{{ url('backend/brand/') }}">Brand</a>
                                        </li>
                                        <li class="sub_menu_group_color"><a
                                                href="{{ url('backend/group_color/') }}">Group Color</a></li>
                                        <li class="sub_menu_product"><a
                                                href="{{ url('backend/product/') }}">Product</a></li>
                                        {{-- <li class="sub_menu_product_photo"><a href="{{url('backend/product_photo/')}}">Product Photo</a></li> --}}
                                        <li class="sub_menu_feature"><a
                                                href="{{ url('backend/feature/') }}">Feature</a></li>
                                        <li class="sub_menu_keyword_product"><a
                                                href="{{ url('backend/keyword_product/') }}">Keyword</a></li>
                                        <li class="sub_menu_import_excel"><a
                                                href="{{ url('backend/import_excel/') }}">Import Excel</a></li>
                                    </ul>
                                </li>
                                ...
                                <li class="has-sub menu_sub_contact_us"><a href="javascript:check_menu(3);">Contact
                                        Us</a>
                                    <ul class="sub-menu sub_menu_3">
                                        <li class="sub_menu_contact_us"><a
                                                href="{{ url('backend/contact_us/') }}">Contact Us</a></li>
                                        <li class="sub_menu_contact_us_form"><a
                                                href="{{ url('backend/contact_us_form/') }}">Contact Us(Form)</a></li>
                                    </ul>
                                </li>
                                <li class="menu_quotation"><a href="{{ url('backend/quotation/') }}">Quotation</a>
                                </li>
                                ...
                                <li class="has-sub menu_sub_report"><a href="javascript:check_menu(4);">Report</a>
                                    <ul class="sub-menu sub_menu_4">
                                        <li class="sub_menu_sale_report"><a
                                                href="{{ url('backend/sale_report/') }}">ยอดขายรายวัน</a></li>
                                        <li class="sub_menu_member_report"><a
                                                href="{{ url('backend/member_report/') }}">รายสมาชิก</a></li>
                                    </ul>
                                </li>
                            </ul>
                        @endif
