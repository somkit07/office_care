...
@section('content')
    <button class="btn btn-sm btn-primary m-r-5" type="button" onclick="window.location.href='{{url('backend/category3/category3_add_edit')}}';" style="margin-bottom: 10px;">Add</button>
        ...
        $(document).ready(function() {
			...
			var TableList = $('#data-table').dataTable({
				...
				dom: 'Bfrtip',
					...
					"columns": [
						{"data" : "category3_id"},
						{"data" : "category3_image"},
						{"data" : "category1_name"},
						{"data" : "category2_name"},
						{"data" : "category3_name"},
						{"data" : "category3_max_price"},
						{"data" : "action"},
					],
				});
