                ...
                <div class="col">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-floating mb-3">
                                        <input type="name" class="form-control" id="floatingInput" placeholder="อีเมล">
                                        <label for="floatingInput">อีเมล</label>
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    <div class="form-floating mb-3">
                                        <input type="name" class="form-control" id="floatingInput" placeholder="ชื่อ">
                                        <label for="floatingInput">ชื่อ</label>
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    <div class="form-floating mb-3">
                                        <input type="name" class="form-control" id="floatingInput" ห
                                            placeholder="นามสกุล">
                                ...
                                <div class="col-lg-12 text-center mt-4 mb-4">
                                    <a href="#" class="btn-primary">สมัครสมาชิก</a>
                                    <div class="contentbl sizesm mt-5 mb-4">หรือ
                                        เชื่อมต่อกับบัญชีออนไลน์</div>
                                    <a href="#" class="btn btn-facebook"><img src="images/fb-icon.png" alt="">
                                        เข้าสู่ระบบด้วย
                                        Facebook</a>
                    ...
                    <div class="login">
                        ...
                        <div class="formdefault mt-4">
                            ...
                            <div class="row">
                                <div class="col-lg-12 text-center mt-4 mb-4">
                                    <a href="#" class="btn-primary">เข้าสู่ระบบ</a>
                                    <div class="contentbl sizesm mt-5 mb-4">หรือ
                                        เชื่อมต่อกับบัญชีออนไลน์</div>
                                    <a href="#" class="btn btn-facebook"><img src="images/fb-icon.png" alt="">
                                        เข้าสู่ระบบด้วย
