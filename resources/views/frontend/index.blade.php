            ...
            <div class="wrapper_pad">
                <div class="row mt-2 mt-lg-3">
                                ...
                                @foreach ($banner_slide as $r)
                                    <div class="item">
                                        ...
                                        <div class="d-none d-sm-none d-md-none d-lg-block d-xl-block">
                                            <img src="{{ asset('public/uploads/banner_slide/' . $r->banner_slide_image) }}"
                                                alt="">
                                        </div>
                                    ...
                                    <a href="{{ $r->banner_slide_link }}" class="mt-3 btn btn-light">ช้อปเลย</a>
                                        ...
                                        <div class="d-block d-sm-block d-md-block d-lg-none d-xl-none">
                                            <a href="{{ $r->banner_slide_link }}"><img
                                                    src="{{ asset('public/uploads/banner_slide/' . $r->banner_slide_image) }}"
                                                    alt=""></a>
                                        </div>
                                    </div>
                                @endforeach
                    ...
                    <div class="col-lg-4 mt-3 mt-md-0">
                        <div class="bannersm">
                            @if (!empty($image_right_index) and $image_right_index->image_right_index_image != '')
                                <img src="{{ asset('public/uploads/image_right_index/' . $image_right_index->image_right_index_image) }}"
                                    class="img-fluid" alt="">
                            @endif
            ...
            <div class="wrapper_pad">
                                    ...
                                    <div class="item">
                                        <div class="productgroup">
                                            <a href="{{ url('product_detail/' . $r->product_id) }}">
                                                <img src="{{ asset('public/uploads/product/' . $r->product_image) }}"
                                                    alt="{{ $r->product_name }}">
                                            </a>
                                            <a href="javascript:insertWishlist({{ $r->product_id }});"
                                                class="wishlist wishlist_{{ $r->product_id }} @if (!empty($wishlist)) {{ 'active' }} @endif"
                                                class="wishlist"><i class="fi fi-rr-heart"></i></a>

                                            <div class="contentProduct pt-3">
                                                <a href="#" class="btn btn-cart" rel="{{ $r->product_id }}"><i
                ...
                <div class="row mt-5">
                    <div class="col">
                        ...
                        <div class="bannerpicmid">
                            @if (!empty($image_right_index) and $image_right_index->image_right_index_center_image != '')
                                <img src="{{ asset('public/uploads/image_right_index/' . $image_right_index->image_right_index_center_image) }}"
                                    class="img-fluid" alt="">
                            @endif
                        </div>
                    </div>
                ...
                <div class="row mt-5">
                    <div class="col-lg-4">
                        <div class="brandsCover">
                            <img src="{{ asset('public/frontend/images/brands_pic_cover.png') }}" class="img-fluid"
                                alt="">
                            <a href="{{ url('brands') }}" class="btn btn-light mt-4">แบรนด์ทั้งหมด</a>
                                ...
                                @foreach ($product_brand as $r)
                                    <div class="col-6 col-lg-6">
                                        <div class="brandgroup hoverstyle">
                                            <figure>
                                                <a href="#">
                                                    <img src="{{ asset('public/uploads/product/' . $r->brand_image) }}"
                                                        alt="">
                                                </a>
                                            </figure>
                                            <div class="logobrand">
                                                <img src="{{ asset('public/uploads/product/' . $r->brand_image2) }}"
                                                    alt="">
                                            </div>
                                        </div>
                                    </div>
                                                ...
                                                <div class="item hoverstyle">
                                                    <figure>
                                                        <a href="{{ url('product/' . $r2->category2_id) }}">
                                                            <img src="{{ asset('public/uploads/category2/' . $r2->category2_image) }}"
                                                                alt="">
                                                        </a>
                                                    </figure>
                        ...
                        <div class="news_slide owl-carousel owl-theme">
                            @if (!empty($news_promotion))
                                @foreach ($news_promotion as $r)
                                    <div class="item hoverstyle">
                                        <figure>
                                            <a href="{{ url('news_detail/' . $r->news_promotion_id) }}"><img
