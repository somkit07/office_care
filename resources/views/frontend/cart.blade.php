        ...
        <div class="container-fluid">
            ...
            <div class="wrapper_pad">
                <div class="row mt-5">
                    <div class="col">
                        <div class="topichead">
                            <h1> ตะกร้าสินค้า <span>(<span class="basket_cart">{{ $count_basket }}</span> ชิ้น)</span>
                            </h1>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="accordion-item">
                                    ...
                                    @foreach (ShoppingCart::all() as $r)
                                        <div id="panelsStayOpen-collapseOne"
                                            class="accordion-collapse collapse show remove_cart_{{ $r->rawId() }}"
                                                ...
                                                <div class="groupcartprd">
                                                    <div class="row mt-3">
                                                        <div class="col-lg-6">
                                                            <div class="row">
                                                                <div class="col-lg-4">
                                                                    <img src="{{ asset('public/uploads/product/' . $r->image) }}"
                                                                        alt="" class="img-fluid">
                                                                </div>
                                                        ...
                                                        <div class="col-lg-6 text-lg-end">
                                                            @if ($r->product_before_discount != $r->price)
                                                                <div class="pt-3 price">
                                                                    ฿ {{ number_format($r->price, 2) }}
                                                                    {!! checkPrice($r->product_before_discount, $r->price) !!}
                                                                </div>
                                                            @else
                                                    ...
                                                    <div class="row text-end">
                                                        <div class="col-lg-2 offset-lg-8">
                                                            <a href="javascript:removeCart('{{ $r->rawId() }}');"
                                                                onclick="return confirm('Confirm Delete');"
                                                                class="smlink">Remove</a>
                                                                ...
                                                                <div class="qty_group_cart mb-2">
                                                                    <div class="input-group"> <span
                                                                            ...
                                                                            <button id="qty-minus" type="button"
                                                                                ...
                                                                                data-field="quant[1]"
                                                                                onclick="minus('{{ $r->rawId() }}');">
                                                                                <i class="fi fi-rr-minus"></i>
                                                                            </button>
                                                                        </span>
                                                                        <input
                                                                            id="CC-prodDetails-quantity_{{ $r->rawId() }}"
                            ...
                            <div class="accordion divradio">
                                @if (!empty($shippingAddress))
                                    <div class="md-radio md-radio-inline radiocheck">
                                        <input id="member_address" type="radio" name="shipping_address"
                                        ...
                                        <label for="member_address">
                                            <div>
                                                ...
                                                <div class="addresscontent">
                                                    {{ $shippingAddress->member_shipping_address_address }}
                                                    @if (!empty($tumbol))
                                                        {{ $tumbol->name_in_thai }}
                                                    @endif
                                                    <br>
                                                    ...
                                                    @endif
                                                    {{ $shippingAddress->member_shipping_address_postcode }} <br>
                                ...
                                @endif
                                <div class="md-radio md-radio-inline radiocheck">
                                    <input id="new_address" type="radio" name="shipping_address"
                                        value="new_address" />
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-6">
                                                            <div class="mb-3">
                                                                <input type="name" class="form-control"
                                                                    id="order_shipping_address_name_surname"
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class=" mb-3">
                                                                <input type="tel" class="form-control"
                                                                    id="order_shipping_address_mobile"
                                                        ...
                                                        <div class="col-lg-12">
                                                            <div class="mb-3">
                                                                <input type="address" class="form-control"
                                                                    id="order_shipping_address_address"
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="input-group mb-3">
                                                                <select class="form-select"
                                                                    aria-label="Default select example"
                                                                    name="amphur_id" id="amphur_id"
                                                                    onchange="changeAmphur(this.value);">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="mb-3">
                                                                <select class="form-select"
                                                                    aria-label="Default select example"
                                                                    name="order_shipping_address_postcode"
                                                                    id="order_shipping_address_postcode" required>
                        ...
                        <div class="sticky-top">
                            <div class="borderbox mt-4 mb-4">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6 col-lg-6 text-end">฿ <span
                                            class="cart_sub_total">{{ number_format($sub_total_inc, 0, '.', ',') }}</span>
                                    </div>
                                    <div class="col-6 col-lg-6">ส่วนลด</div>
                                    <div class="col-6 col-lg-6 text-end cart_discount">
                                        {{ number_format($discount, 0, '.', ',') }}</div>
                                    <div class="col-6 col-lg-6">ค่าจัดส่ง</div>
                                    <div class="col-6 col-lg-6 text-end cart_shipping">
                                        {{ number_format($shipping, 0, '.', ',') }}</div>
                                    <div class="col-6 col-lg-6">ราคารวม</div>
                                    <div class="col-6 col-lg-6 text-end"><span class="price">฿ <div
                                                class="cart_total" style="display: inline-block;">
                                                {{ number_format($total, 0, '.', ',') }}</div></span></div>
                                </div>
                            </div>
                                ...
                                <div class="col">
                                    <div class="btngroup">
                                        ...
                                        @if (Session::get('member_id') != '')
                                            <a href="javascript:setQuatation();" class="btn btn-borderblue"><i
                                                    class="fi fi-rr-download"></i> ดาวน์โหลด PDF</a>

                                            <a href="#" class="btn btn-subwidth" data-width="948"
                                                data-height="700" data-fancybox data-src="#invoice"
                                                href="javascript:;"><i class="fi fi-rr-document-signed"></i>
                                                ขอใบเสนอราคา</a>
                                            {{-- End Login แล้ว --}}

                                            {{-- ยังไมได้ Login --}}
                                        @else
                                            <a href="javascript:setQuatation();" class="btn btn-borderblue"
                                                data-bs-toggle="offcanvas" data-bs-target="#offcanvasRight"
                                                aria-controls="offcanvasRight"><i class="fi fi-rr-download"></i>
                                                ดาวน์โหลด PDF</a>

                                            <a href="#" class="btn btn-subwidth" data-bs-toggle="offcanvas"
                                                data-bs-target="#offcanvasRight" aria-controls="offcanvasRight"><i
                                                    class="fi fi-rr-document-signed"></i> ขอใบเสนอราคา</a>
                                        @endif
                                        {{-- End ยังไมได้ Login --}}
                                        <div style="display: none;" id="invoice">
                                            <form action="{{ url('saveQuatation') }}" method="post">
                                                ...
                                                <div class="formdefault mt-4">
                                                    <div class="row">
                                                        <div class="col-lg-12">
                                                            <div class="form-floating mb-3">
                                                                <input type="text" class="form-control"
                                                                    id="quotation_company" name="quotation_company"
                                                        ...
                                                        <div class="col-lg-12">
                                                            <div class="form-floating mb-3">
                                                                <input type="text" class="form-control"
                                                                    id="quotation_contact" name="quotation_contact"
                                                                    placeholder="ชื่อผู้ติดต่อ"
                                                                    value="@if (!empty($row)) {{ $row->member_name . ' ' . $row->member_surname }} @endif">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="form-floating mb-3">
                                                                <input type="text" class="form-control"
                                                                    id="quotation_tel" name="quotation_tel"
                                                                    placeholder="เบอร์ติดต่อ"
                                                                    value="@if (!empty($row)) {{ $row->member_mobile }} @endif">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="form-floating mb-3">
                                                                <input type="text" class="form-control"
                                                                    id="quotation_email" name="quotation_email"
                                                                    placeholder="อีเมล"
                                                                    value="@if (!empty($row)) {{ $row->member_email }} @endif">
                                                        ...
                                                        <div class="col-lg-12">
                                                            <div class="form-floating mb-3">
                                                                <input type="text" class="form-control"
                                                                    id="quotation_message" name="quotation_message"
                                                                    placeholder="ข้อความ">
                                                ...
                                                <center><input type="submit" class="btn btn-primary"
                                                        value="ส่งคำขอใบเสนอราคา"></center>
                                            </form>
                                        </div>
                                    </div>
                                </div>
        ...
        function setQuatation() {
            if (member_id == '') {
                ...
                $.post('{{ url('ajaxSavePdf') }}', {
                    ...
                    member_shipping_address_name_surname: member_shipping_address_name_surname,
                    member_shipping_address_mobile: member_shipping_address_mobile,
                    member_shipping_address_address: member_shipping_address_address,
                    province_id: province_id,
                    amphur_id: amphur_id,
                    tumbol_id: tumbol_id,
