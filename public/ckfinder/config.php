...
function CheckAuthentication()
{
	...
	/*$session = unserialize($_COOKIE['cisession']);
...
//WP9EJDVXZE1J99DEH554QNY53, ADEJVN1TB98U7M3SMHT5R6J8B, RC1CB6FMJU6DSG67TEFM2JEN1, ATRDCZQ2BREMBXU8FNDU5K2XZ, FK21ZP17HSKU9SAV329QY4YER, F8WWAUWSDXSC5MTK4L5XCETFF, 55D63TXF2UBBEN7315VDRNXU9, 5SLGK1XN6BU9E4RP5L1F87J9B, FM32KWAMNW48NW1W3BQBFGZK2, 5197KHJX5LZQ1HAC66FD3G95T
...
ATTENTION: The trailing slash is required.
*/
$baseDir = resolveUrl($baseUrl);//resolveUrl($baseUrl);
//$baseDir = resolveUrl('/demo/vejthani2/uploads/ckeditor/'.$_SESSION['DIR_SELF'].'/');//resolveUrl($baseUrl);
